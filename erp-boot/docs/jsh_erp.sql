...
CREATE TABLE `jsh_cashier_session_product_item` (
  ...
  `bar_code_snap` varchar(100) DEFAULT NULL COMMENT '条码快照',
  `unit_snap` varchar(50) DEFAULT NULL COMMENT '单位快照',
  `unit_price` decimal(24,6) DEFAULT '0.000000' COMMENT '单价',
  `qty` decimal(24,6) DEFAULT '1.000000' COMMENT '数量',
  `amount` decimal(24,6) DEFAULT '0.000000' COMMENT '金额',
  `sales_man_id` bigint(20) DEFAULT NULL COMMENT '销售员(经手人)id',
  `commission_percent` decimal(24,6) DEFAULT '0.000000' COMMENT '提成比例(%)',
  `commission_amount` decimal(24,6) DEFAULT '0.000000' COMMENT '提成金额',
