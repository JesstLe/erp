...
function applyMembershipPricing(lines: ClassicCashierDraftLine[], customer?: CustomerDetail) {
  ...
  return lines.map((line) => {
    ...
    return { ...line, enteredPriceMinor: Math.round(line.referencePriceMinor * basisPoints / 10_000),
      priceOverrideReason: `会员折扣：${card.cardTypeName} ${(basisPoints / 1000).toFixed(2).replace(/0+$/, '').replace(/\.$/, '')}折`,
