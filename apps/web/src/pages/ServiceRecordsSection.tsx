...
import type { PageResult, ServiceRecord, ServiceRecordCategory, ServiceRecordOrderOption } from '../api/types'
import { Permission } from '../security/permissions'
import { useAuthorization } from '../security/useAuthorization'

interface ServiceRecordForm { serviceOccurredAt: string; serviceOrderId?: string; categoryId?: string; conditionNotes?: string; serviceContent?: string; followUpNotes?: string }
