...
public sealed record StoreProfileDto(Guid Id, string Code, string Name, string TimeZoneId, string? Address, string Status,
...
public sealed record CreateStoreCommand(string Name, string TimeZoneId, string? Address, Guid OperatorId);
public sealed record UpdateStoreCommand(Guid StoreId, string Code, string Name, string TimeZoneId, string? Address,
