...
internal static class EndpointResults
{
    public static IResult From<T>(Result<T> result, Func<T, IResult>? onSuccess = null)
    {
        ...
        var status = error.Code switch
        {
            ...
            "VERIFICATION_DELIVERY_UNAVAILABLE" or "CHANNEL_UNAVAILABLE" or "CHANNEL_QUERY_FAILED" or "CHANNEL_CLOSE_FAILED" or "CHANNEL_REFUND_UNAVAILABLE" or "CHANNEL_BILL_UNAVAILABLE" or "CHANNEL_BILL_DOWNLOAD_FAILED" => StatusCodes.Status503ServiceUnavailable,
