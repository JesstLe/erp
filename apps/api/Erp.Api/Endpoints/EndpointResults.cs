...
internal static class EndpointResults
{
    public static IResult From<T>(Result<T> result, Func<T, IResult>? onSuccess = null)
    {
        ...
        var status = error.Code switch
        {
            ...
            "NOT_FOUND" or "FACILITY_NOT_FOUND" or "FACILITY_SESSION_NOT_FOUND" or "CLEANING_TASK_NOT_FOUND" or "CUSTOMER_NOT_FOUND" or "MEMBER_CARD_TYPE_NOT_FOUND" or "MEMBER_CARD_NOT_FOUND" or "MEMBER_ACCOUNT_NOT_FOUND" or "MEMBER_TOPUP_NOT_FOUND" or "MEMBER_VERIFICATION_NOT_FOUND" or "SERVICE_ORDER_NOT_FOUND" or "PRICE_BOOK_NOT_FOUND" or "PAYMENT_NOT_FOUND" or "PAYMENT_METHOD_NOT_FOUND" or "SHIFT_NOT_FOUND" => StatusCodes.Status404NotFound,
            ...
            "PAYMENT_ALLOCATION_UNBALANCED" or "PAYMENT_METHOD_NOT_ALLOWED" or "MEMBER_CUSTOMER_REQUIRED" or "MEMBER_MOBILE_REQUIRED" or "MEMBER_MOBILE_MISMATCH" or "MEMBER_ACCOUNT_REQUIRED" or "MEMBER_ACCOUNT_TYPE_MISMATCH" or "MEMBER_VERIFICATION_CODE_INVALID" or "INSUFFICIENT_MEMBER_BALANCE" => StatusCodes.Status422UnprocessableEntity,
