...
V1 完成建档、查询、卡类配置、开卡和零余额账户初始化。V2 已增加独立的[会员储值与资金分账](11-member-topups.md)以及[会员余额消费与手机号验证](12-member-balance-payments.md)；开卡仍不会自动储值，页面也没有“直接改余额”入口。
...
- 列表和普通详情接口不返回手机号明文、完整卡号或生日；完整手机号只由单独的目的必填接口短暂返回。
