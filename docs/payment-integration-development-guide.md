...
实现进度说明：统一支付单、可配置支付方式、组合分摊、现金记录、微信/支付宝人工登记待核对和收银班次已经进入可运行代码；本文件所述 Native/订单码渠道适配器、回调、查单、退款和渠道对账仍未实现。可运行人工路径见[现金、人工外部收款与收银交班](user-manual/06-payments-and-cashier-shifts.md)。
